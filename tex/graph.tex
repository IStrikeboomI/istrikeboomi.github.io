...
\addplot[incl, draw=blue] coordinates {(3,4)} node[above] {$Q$};
\addplot[incl, draw=blue] coordinates {(1,1)} node[above] {$P$};

\draw[line width=2pt, blue, -latex] (1,1) -- (3,4) node[sloped,above,midway,scale = 2] {$\vec{PQ}$};
\draw[line width=2pt, green, -latex] (1,1) -- (4,1) node[sloped,below,midway, scale = 2] {$\vec{u}$};
\draw[line width=2pt, green, dashed] (3,1) -- (3,4) node[right,midway, scale = 1] {$||\vec{PQ}||\sin(\theta)$};
