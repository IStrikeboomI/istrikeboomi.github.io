...
\draw[line width=2pt, blue, -latex] (0,0) -- (6,2) node[sloped,above,scale = 2] {$\vec{v}$};
...
\draw [red, very thick, dashed] (3,4) -- (3,1);
\draw [red, line width=2pt] (0,0) -- (3,1) node [sloped, below,midway, scale = 1.5] {$\vec{v} \cdot \vec{u}$};
