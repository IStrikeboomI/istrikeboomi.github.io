...
\draw (0,0) node[seven segment val=2 dot none box on] () {};
\draw (1,0) node[seven segment val=B dot none box on] () {};
\draw (2,0) node[seven segment val=1 dot none box on] () {};
\draw (3,0) node[seven segment val=8 dot none box on] () {};
